...
var _brand = require('../controllers/brand.controllers');

var brandCtrl = _interopRequireWildcard(_brand);
...
router.get('/', _middlewares.authJwt.verifyUserToken, brandCtrl.getBrands);
